...
// IMPORT the shared client. Do NOT use createClient() here.
...
const ResetPassword = () => {
  ...
  useEffect(() => {
    // 1. Check if we have a session (the email link creates one automatically)
    ...
    // 2. Listen for the recovery event to confirm readiness
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      // CRITICAL FIX: Sign out immediately. 
      // This clears the "Recovery" state so the user isn't looped back here.
